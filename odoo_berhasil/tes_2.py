...
def get_server_info_ssh(hostname, port, username, private_key_path):
    try:
...
if __name__ == "__main__":
    ...
    username = "root"
    port = 2023
    private_key_path = "/home/farissu/utama/gitclone/odoo_costum/odoo_berhasil/id_rsa"  # Replace with the actual private key path
    get_server_info_ssh(hostname, port, username, private_key_path)